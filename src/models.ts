...
export const MODEL_PRESETS: ModelPreset[] = [
  ...
  },
  {
    ...
    label: "MiniCPM5 2B q4f16 — Transformers.js/WebGPU (~3 GB VRAM est.)",
    shortName: "MiniCPM5 2B",
    description:
      "OpenBMB's regular MiniCPM5 2B instruction model, quantized for browser GPU inference with streaming, optional thinking and measured token/timing metrics.",
    approximateDownload: "~1.83 GB ONNX weights plus tokenizer and browser cache overhead",
    vramRequiredMB: 3072,
    vramSource: "estimated",
    lowResourceRequired: false,
    disableThinkingSupported: true,
    defaultRuntime: extractionPreset({ maxTokens: 768, disableThinking: true }),
    source: "transformers-onnx",
    backend: "transformers-js",
    stability: "experimental",
    officialRepo: "https://huggingface.co/openbmb/MiniCPM5-2B",
    artifactRepo: "https://huggingface.co/RASMUS/MiniCPM5-2B-ONNX",
    transformersDtype: "q4f16",
    brand: "OpenBMB",
    notes: "Requires WebGPU shader-f16. JSON schema mode is prompt-only. Browser memory depends on context length; the VRAM figure is an estimate.",
  },
  {
    id: "j4ys0n/MiniCPM5-2B-heretic-abliterated-ONNX",
    label: "MiniCPM5 2B Heretic q4f16 — Transformers.js/WebGPU (~3 GB VRAM est.)",
    shortName: "MiniCPM5 2B Heretic",
    description:
      "Heretic-abliterated MiniCPM5 2B, converted from the original insraq safetensors checkpoint to browser-ready ONNX with streaming, optional thinking and measured token/timing metrics.",
    approximateDownload: "~1.83 GB ONNX weights plus tokenizer and browser cache overhead",
    vramRequiredMB: 3072,
    vramSource: "estimated",
    lowResourceRequired: false,
    ...
    backend: "transformers-js",
    stability: "experimental",
    officialRepo: "https://huggingface.co/insraq/MiniCPM5-2B-heretic-abliterated",
    artifactRepo: "https://huggingface.co/j4ys0n/MiniCPM5-2B-heretic-abliterated-ONNX",
    transformersDtype: "q4f16",
    brand: "OpenBMB",
    notes: "Original Heretic checkpoint referenced by Abiray's model card. Requires WebGPU shader-f16. JSON schema mode is prompt-only; VRAM usage is estimated.",
  },
  {
